...
<div class="form-group col-sm-6">
    {!! Form::label('ano', 'Ano:') !!}
    {!! Form::text('ano', null, ['class' => 'form-control date', 'data-provide' => 'datepicker']) !!}
</div>

<!-- Data Doc Field -->
<div class="form-group col-sm-6">
    {!! Form::label('data_doc', 'Data do Documento:') !!}
    {!! Form::text('data_doc', $documento->data_doc->format('d/m/Y'), ['class' => 'form-control date', 'data-provide' => 'datepicker']) !!}
</div>
